...
def main():
    ...
    for identifier in identifiers:
        ...
        model_path = (
            f"/srv/beegfs02/scratch/3dhumanobjint/data/H2O/trained_models/model_rural-sponge-3163_epoch_1197.pt"
        )
        ...
        for idx in range(0, last_frame, 1):
            ...
            for cam_id in [3]:
                ...
                transformed_object = plot_obj_in_camera_frame(
                    current_abs_obj_pose, current_abs_obj_trans, object_mesh_sim
                )
