        ...
        for idx in range(0, last_frame, 1):
            ...
            for cam_id in [2]:
                ...
                transformed_object = plot_obj_in_camera_frame(
                    current_abs_obj_pose, current_abs_obj_trans, obj_template_path
                )
                ...
                new_positions2, _ = simplify_mesh(
                    np.asarray(transformed_object.vertices),
                    np.asarray(transformed_object.triangles).astype(np.uint32),
                    final_num_nodes,
                )
