...
if __name__ == "__main__":
    ...
    for (
        ...
        class CombinedTrans(pl.LightningModule):
            ...
            def training_step(self, cam_data):
                ...
                for i in range(0, smpl_pose.shape[0], n):
                    ...
                    # Logging the losses
                    self.log(
                        "train_pose_loss", mean_pose_loss, on_step=False, on_epoch=True, prog_bar=True, logger=True
                    )
                    self.log(
                        "train_trans_loss", mean_trans_loss, on_step=False, on_epoch=True, prog_bar=True, logger=True
                    )
                    self.log(
        ...
        labels = ["Date01_Sub01_boxmedium_hand"]
        #    "Date03_Sub03_boxmedium"]
        ...
        print("\nTraining\n", flush=True)
        trainer = pl.Trainer(
            max_epochs=wandb.config.epochs, logger=wandb_logger, num_sanity_val_steps=0
