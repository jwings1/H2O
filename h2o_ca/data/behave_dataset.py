...
class BehaveDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(train_dataset, batch_size=self.batch_size, shuffle=False, drop_last=False, num_workers=0)

    def val_dataloader(self):
        val_dataset = Subset(self.dataset, self.val_indices)
        return DataLoader(val_dataset, batch_size=self.batch_size, drop_last=False, num_workers=0)

    def test_dataloader(self):
        test_dataset = Subset(self.dataset, self.test_indices)
        return DataLoader(test_dataset, batch_size=self.batch_size, drop_last=False, num_workers=0)
