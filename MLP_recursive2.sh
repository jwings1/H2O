...
#SBATCH --job-name="MLP"
#SBATCH --error=/scratch_net/biwidl307/lgermano/crossvit/log/error/%j.err
#SBATCH --output=/scratch_net/biwidl307/lgermano/crossvit/log/out/%j.out
#SBATCH --mem=50G
#SBATCH --gres=gpu:1

TMPDIR=/scratch_net/biwidl307/lgermano/crossvit/wandb/cache
...
python /scratch_net/biwidl307/lgermano/crossvit/MLP_recursive2.py
