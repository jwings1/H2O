...
for lr, bs, dr, layers in itertools.product(
    ...
    reprojected_cam1_tensors = sliding_window_grouping(data_retrieved['reprojected_cam1'], N_MLPS, data_retrieved['identifiers'], group_identifiers)
    reprojected_cam0_tensors = sliding_window_grouping(data_retrieved['reprojected_cam0'], N_MLPS, data_retrieved['identifiers'], group_identifiers)
    reprojected_cam2_tensors = sliding_window_grouping(data_retrieved['reprojected_cam2'], N_MLPS, data_retrieved['identifiers'], group_identifiers)
    reprojected_cam3_tensors = sliding_window_grouping(data_retrieved['reprojected_cam3'], N_MLPS, data_retrieved['identifiers'], group_identifiers)
