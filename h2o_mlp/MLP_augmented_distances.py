...
for lr, bs, dr, layers in itertools.product(
    ...
    input_dim = 75
    # print(len(reprojected_smpl_cam0_list))
    output_dim = reprojected_obj_cam0_list[0].shape[0]
    # print(output_dim)
    ...
    model_path = (
        f"/scratch_net/biwidl307/lgermano/H2O/trained_models/model_offset_trans_smpl_augmented_dandy-sun-1102.pt"
    )
