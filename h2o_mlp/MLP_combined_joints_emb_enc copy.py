...
for lr, bs, dr, layers_1, layers_3, alpha, lambda_1, lambda_2, l, epochs, optimizer_name in itertools.product(
    ...
    class CombinedMLP(pl.LightningModule):
        ...
        def training_step(self, batch, batch_idx):
            ...
            #################################################
            # Loss for camera 1
            loss_cam1_stage2 = lambda_1 * F.mse_loss(y_hat_cam1_stage2, y_cam1_stage2) + lambda_1 * F.cosine_similarity(y_hat_cam1_stage2, y_cam1_stage2) + lambda_2 * smooth_sign_loss(y_hat_cam1_stage2, y_cam1_stage2)
            
            # Loss for camera 0
            loss_cam0_stage2 = lambda_1 * F.mse_loss(y_hat_cam0_stage2, y_cam0_stage2) + lambda_1 * F.cosine_similarity(y_hat_cam0_stage2, y_cam0_stage2) + lambda_2 * smooth_sign_loss(y_hat_cam0_stage2, y_cam0_stage2)

            # Loss for camera 3
            loss_cam3_stage2 = lambda_1 * F.mse_loss(y_hat_cam3_stage2, y_cam3_stage2) + lambda_1 * F.cosine_similarity(y_hat_cam3_stage2, y_cam3_stage2) + lambda_2 * smooth_sign_loss(y_hat_cam3_stage2, y_cam3_stage2)

            # Loss for camera 2
            loss_cam2_stage2 = lambda_1 * F.mse_loss(y_hat_cam2_stage2, y_cam2_stage2) + lambda_1 * F.cosine_similarity(y_hat_cam2_stage2, y_cam2_stage2) + lambda_2 * smooth_sign_loss(y_hat_cam2_stage2, y_cam2_stage2)
