...
input_data = np.concatenate([reprojected_smpl_cam1_list, reprojected_smpl_cam0_list, reprojected_smpl_cam2_list, reprojected_smpl_cam3_list], axis=0)

# Concatenate the label arrays
labels = np.concatenate([reprojected_obj_cam1_list, reprojected_obj_cam0_list, reprojected_obj_cam2_list, reprojected_obj_cam3_list], axis=0)
...
data.columns = [f'pose_{i}' for i in range(72)] + ['trans_x', 'trans_y', 'trans_z', 'obj_pose_x', 'obj_pose_y', 'obj_pose_z']
