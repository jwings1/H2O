...
epochs_range = [10]  # ,300]
learning_rate_range = [1e-7, 5e-7, 1e-6, 5e-6, 1e-5]  # [1e-6]#, 5e-3, 1e-2, 5e-2]
        ...
        def configure_optimizers(self):
            ...
            scheduler = {
                "scheduler": ReduceLROnPlateau(
                    optimizer, "min", patience=1, verbose=True, factor=0.01, threshold=0.75, threshold_mode="rel"
                ),
            ...
            # scheduler = {
            # 'scheduler': CustomCyclicLR(optimizer, base_lr=1e-7, max_lr=5e-6, step_size=1, mode='exp_range'),
