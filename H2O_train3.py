...
if __name__ == "__main__":
    ...
    for lr, bs, dr, layers_1, layers_3, alpha, lambda_1, lambda_2, lambda_3, lambda_4, l, epochs, optimizer_name in itertools.product(
        ...
        def project_frames(data_frames, timestamps, N):
            ...
            for idx, input_frame in enumerate(data_frames):
        ...
        class BehaveDataset(Dataset):
            ...
            def __getitem__(self, idx):
                ...
                def extract_and_convert(cam_id):
                    ...
                    keys = ['enc_unrolled_pose_trace', 'enc_norm_joints_trace', 'prev_obj_pose', 'prev_obj_trans', 'obj_pose', 'obj_trans']
        ...
        labels=['Date01_Sub01_boxmedium_hand', 'Date02_Sub02_boxmedium_hand', 'Date03_Sub03_boxmedium', 'Date03_Sub04_boxmedium', 'Date03_Sub05_boxmedium', 'Date04_Sub05_boxmedium', 'Date05_Sub06_boxmedium', 'Date06_Sub07_boxmedium', 'Date07_Sub04_boxmedium', 'Date07_Sub08_boxmedium']
        ...
        input_dim = 72 * wandb.config.L * 2 if "enc" in (SMPL_POSE or SMPL_JOINTS) else 72
        input_stage3 = 3 * wandb.config.L * 2 if "enc" in (OBJ_POSE or OBJ_TRANS) else 6
