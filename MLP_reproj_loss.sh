...
#SBATCH --error=/scratch_net/biwidl307/lgermano/H2O/MultiGPU/log/error/%j.err
#SBATCH --output=/scratch_net/biwidl307/lgermano/H2O/MultiGPU/log/out/%j.out
#SBATCH --mem=30G
#SBATCH --gres=gpu:1
...
python /scratch_net/biwidl307/lgermano/H2O/MLP_reproj_loss.py
